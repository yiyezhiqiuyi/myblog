...
<#if articleVoIPage?? && articleVoIPage.list?size gt 0 >
    <form class="form-horizontal" action="/myblog/article/list" method="get">
        <div class="form-group">
            ...
            <div class="cpl-sm-2">
                ...
                <a href="/myblog/article/list" class="btn btn-success"><i class="icon-search"></i> 全部</a>
            </div>
        </div>
    </form>
    <div class="panel">
...
<script type="text/javascript">
    ...
    function getNewData(pageNumber) {
        ...
        window.location.href = "/myblog/article/list?pageNumber=" + pageNumber + "<#if (articleName?? && articleName?length>0)>&articleName=${articleName!}</#if>";
    }
